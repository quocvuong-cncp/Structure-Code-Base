...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.ActionInFunction", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.Function", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.Permission", b =>
                {
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.ActionInFunction", b =>
                {
                    b.HasOne("Domain.Domain.Entities.Identity.Action", null)
                        .WithMany("ActionInFunctions")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Domain.Entities.Identity.Function", null)
                        .WithMany("ActionInFunctions")
            ...
            modelBuilder.Entity("Domain.Domain.Entities.Identity.Permission", b =>
                {
                    ...
                    b.HasOne("Domain.Domain.Entities.Identity.AppRole", null)
                        .WithMany("Permissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Domain.Domain.Entities.Identity.AppUser", null)
                        .WithMany("Claims")
